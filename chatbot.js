...
(function ChatBot() {
  ...
  function buildDOM() {
    ...
    elBubble.innerHTML = '<img src="puce avatar.png" alt="Puce" id="cb-cat-img">';

    elPanel = make('div', { id: 'cb-panel', role: 'dialog', 'aria-label': 'Assistant du cabinet vétérinaire' });
    elPanel.innerHTML = `
      <div class="cb-header">
        <div class="cb-header-info">
          <div class="cb-header-avatar"><img src="puce avatar.png" alt="Puce" style="width:100%;height:100%;object-fit:contain;"></div>
          <div>
